                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col items-center gap-4">
                      ...
                      <motion.div layout className="flex flex-col items-center">
                        <p className={`font-rajdhani text-2xl font-extrabold uppercase tracking-wider transition-colors duration-300 ${isSelected ? "text-primary" : "text-gray-600 dark:text-white/60 group-hover:text-foreground"
