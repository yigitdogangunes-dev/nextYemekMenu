...
export default function ProfileSelector({ selectedProfile, setSelectedProfile }) {
  const profiles = [
    ...
    { id: "denemeeeeeeeeeeee2", name: "Deneme 2", avatar: "/assets/avatar.jpg" },
  ];
          ...
          {profiles.map((profile, i) => {
            ...
            return (
              <motion.div 
                ...
                onClick={() => setSelectedProfile(isSelected ? null : profile.name)}
              ...
              >
                {/* Teal Style Hover Glow for Light Mode - INTERNAL ONLY */}
                ...
                {/* Clean white backdrop with slight blur -> Dark mode black backdrop */}
