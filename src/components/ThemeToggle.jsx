    ...
    >
      <AnimatePresence mode="popLayout" initial={false}>
        {isDark ? (
          ...
          >
            <Sun className="w-6 h-6 text-primary-light group-hover:drop-shadow-[0_0_8px_rgba(20,184,166,0.6)]" />
          </motion.div>
        ) : (
          <motion.div
            key="moon"
            ...
            transition={{ duration: 0.3 }}
          >
            <Moon className="w-6 h-6 text-gray-700 group-hover:drop-shadow-[0_0_8px_rgba(139,92,246,0.5)]" />
          </motion.div>
        )}
      </AnimatePresence>
    </motion.button>
